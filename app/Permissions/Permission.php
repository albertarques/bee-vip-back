...
class Permission
{
  ...
  // Users Permissions =====================================================
    ...
    public const CAN_UPDATE_USER_PROFILE = "user-update-profile";
  ...
  public const CAN_VIEW_PAYMENT_METHODS = "payment-method-view";
  public const CAN_SHOW_PAYMENT_METHOD = "payment-method-show";
  public const CAN_UPDATE_PAYMENT_METHOD = "payment-method-update";

  // Orders Permissions ====================================================
  public const CAN_CREATE_ORDER = "order-create";
  public const CAN_VIEW_ORDERS = "orders-view-my";
  public const CAN_SHOW_ORDER = "order-show";
  ...
  // Entrepreneurships Permissions =========================================
    // Admin user
      ...
      public const CAN_UPDATE_MY_ENTREPRENEURSHIP = "entrepreneurship-update";
